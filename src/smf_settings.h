...
/*!
 * @fn int smf_settings_set_debug(int debug)
...
/*!
 * @fn int smf_settings_get_debug(void)
...
/*!
 * @fn int smf_settings_set_config_file(char *cf)
...
/*!
 * @fn char *smf_settings_get_config_file(void)
...
/*!
 * @fn int smf_settings_set_queue_dir(char *qd)
...
/*!
 * @fn char *smf_settings_get_queue_dir(void)
...
/*!
 * @fn void smf_settings_set_engine(char *engine)
...
/*!
 * @fn char *smf_settings_get_engine(void)
...
/*!
 * @fn void smf_settings_set_modules(char **modules)
...
/*!
 * @fn char **smf_settings_get_modules(void)
...
/*!
 * @fn void smf_settings_set_module_fail(int i)
...
/*!
 * @fn int smf_settings_get_module_fail(void);
...
/*!
 * @fn void smf_settings_set_nexthop(char *nexthop)
...
/*!
 * @fn char *smf_settings_get_nexthop(void)
...
/*!
 * @fn void smf_settings_set_nexthop_fail_code(int i)
...
/*!
 * @fn int smf_settings_get_nexthop_fail_code(void)
...
/*!
 * @fn void smf_settings_set_nexthop_fail_msg(char *msg)
...
/*!
 * @fn char *smf_settings_get_nexthop_fail_msg(void)
...
/*!
 * @fn void smf_settings_set_backend(char **backend)
...
/*!
 * @fn char **smf_settings_get_backend(void)
...
/*!
 * @fn void smf_settings_set_backend_connection(char *conn)
...
/*!
 * @fn char *smf_settings_get_backend_connection(void)
...
/*!
 * @fn void smf_settings_set_add_header(int i)
...
/*!
 * @fn int smf_settings_get_add_header(void)
...
/*!
 * @fn void smf_settings_set_max_size(unsigned long size)
...
/*!
 * @fn unsigned long smf_settings_get_max_size(void)
...
/*!
 * @fn void smf_settings_set_tls(SMFTlsOption_T t)
...
/*! 
 * @fn SMFTlsOption_T smf_settings_get_tls(void)
...
/*!
 * @fn void smf_settings_set_tls_pass(char *pass)
...
/*!
 * @fn char *smf_settings_get_tls_pass(void)
...
/*!
 * @fn void smf_settings_set_daemon(int i)
...
/*!
 * @fn int smf_settings_get_daemon(void)
...
/*!
 * @fn void smf_settings_set_sql_driver(char *driver)
...
/*!
 * @fn char *smf_settings_get_sql_driver(void)
...
/*!
 * @fn void smf_settings_set_sql_name(char *name)
...
/*!
 * @fn char *smf_settings_get_sql_name(void)
...
/*!
 * @fn void smf_settings_set_sql_host(char **host)
...
/*!
 * @fn char **smf_settings_get_sql_host(void)
...
/*!
 * @fn int smf_settings_get_sql_num_hosts(void)
...
/*!
 * @fn void smf_settings_set_sql_port(int port)
 * @brief Set SQL port
 * @param port sql port
 */
...
/*!
 * @fn int smf_settings_get_sql_port(void)
 * @brief Get SQL port
...
/*!
 * @fn void smf_settings_set_sql_user(char *user)
...
/*!
 * @fn char *smf_settings_get_sql_user(void)
...
/*!
 * @fn void smf_settings_set_sql_pass(char *pass)
...
/*!
 * @fn char *smf_settings_get_sql_pass(void)
...
/*!
 * @fn void smf_settings_set_sql_user_query(char *query)
...
/*!
 * @fn char *smf_settings_get_sql_user_query(void)
...
/*!
 * @fn void smf_settings_set_sql_encoding(char *encoding)
...
/*!
 * @fn char *smf_settings_get_sql_encoding(void)
...
/*!
 * @fn void smf_settings_set_sql_max_connections(int i)
...
/*!
 * @fn int smf_settings_get_sql_max_connections(void)
...
/*!
 * @fn void smf_settings_set_ldap_uri(char *uri)
 * @brief Set LDAP uri
...
/*!
 * @fn char *smf_settings_get_ldap_uri(void)
 * @brief Get LDAP uri
...
/*!
 * @fn void smf_settings_set_ldap_host(char **host)
...
/*!
 * @fn char **smf_settings_get_ldap_host(void)
...
/*!
 * @fn void smf_settings_set_ldap_port(int port)
 * @brief Set LDAP port
...
/*!
 * @fn int smf_settings_get_ldap_port(void)
 * @brief Get LDAP port
...
/*!
 * @fn void smf_settings_set_ldap_binddn(char *binddn)
...
/*!
 * @fn char *smf_settings_get_ldap_binddn(void)
...
/*!
 * @fn void smf_settings_set_ldap_bindpw(char *bindpw)
...
/*! 
 * @fn char *smf_settings_get_ldap_bindpw(void)
...
/*!
 * @fn void smf_settings_set_ldap_base(char *base)
...
/*!
 * @fn char *smf_settings_get_ldap_base(void)
...
/*!
 * @fn void smf_settings_set_ldap_referrals(int i)
...
/*!
 * @fn int smf_settings_get_ldap_referrals(void)
...
/*!
 * @fn void smf_settings_set_ldap_scope(char *scope)
...
/*!
 * @fn char *smf_settings_get_ldap_scope(void)
...
/*!
 * @fn void smf_settings_set_ldap_user_query(char *query)
...
/*!
 * @fn char *smf_settings_get_ldap_user_query(void)
