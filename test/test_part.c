...
int main (int argc, char const *argv[]) {
    ...
    printf("Start SMFPart_T tests...\n");

    printf("* testing smf_part_new()...\t\t\t\t\t");
    part = smf_part_new();
    assert(part);
    printf("passed\n");

    printf("* testing smf_part_set_content_type()...\t\t\t");
    smf_part_set_content_type(part,mime_type_string);
    printf("passed\n");

    printf("* testing smf_part_get_content_type()...\t\t\t");
    ...
    printf("* testing smf_part_set_content_disposition()...\t\t\t");
    smf_part_set_content_disposition(part,mime_disposition_string);
    printf("passed\n");

    printf("* testing smf_part_get_content_disposition()...\t\t\t");
    ...
    printf("* testing smf_part_set_content_transfer_encoding()...\t\t");
    smf_part_set_content_transfer_encoding(part,mime_encoding_string);
    printf("passed\n");

    printf("* testing smf_part_get_content_transfer_encoding()...\t\t");
    ...
    printf("* testing smf_part_set_content_id()...\t\t\t\t");
    smf_part_set_content_id(part,id_string_out);
    printf("passed\n");

    printf("* testing smf_part_get_content_id()...\t\t\t\t");
    ...
    printf("* testing smf_part_set_content()...\t\t\t\t");
    smf_part_set_content(part,test_content_string);
    printf("passed\n");

    printf("* testing smf_part_get_content()...\t\t\t\t");
    ...
    printf("* testing smf_part_set_postface()...\t\t\t\t");
    smf_part_set_postface(part, test_postface_string);
    printf("passed\n");

    printf("* testing smf_part_get_postface()...\t\t\t\t");
    ...
    printf("* testing smf_part_to_string()...\t\t\t\t");
    out = smf_part_to_string(part,NULL);
    assert(s);
    printf("passed\n");

    printf("* testing smf_part_free()...\t\t\t\t\t");
    smf_part_free(part);
    printf("passed\n");

    printf("* testing smf_part_from_string()...\t\t\t\t");
    part = smf_part_new();
    ...
    printf("* testing smf_part_from_file()...\t\t\t\t");
    part = smf_part_new();
